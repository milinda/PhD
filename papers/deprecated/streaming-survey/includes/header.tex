...
\title{Survey of Modern Distributed Stream Processing Systems}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Milinda Pathirage}
\IEEEauthorblockA{School of Informatics and\\Computing\\
Indiana University\\
Email: mpathira@indiana.edu}
\and
\IEEEauthorblockN{Beth Plale}
\IEEEauthorblockA{School of Informatics and\\Computing\\
Indiana University\\
...
\begin{abstract}
Interest on continuous queries over streams of data has increased over last couple of years due to
 ...
 Streaming} and LinkedIn's \textit{Samza} were introduced into the fast growing Big Data eco-system.
 ...
 In this paper we compare and contrast modern distributed stream processing
 systems -- \textit{S4, Storm, Spark Streaming and Samza} -- based on 
